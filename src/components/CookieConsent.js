                ...
                >
                    <div className="glass" style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                            ...
                            <div>
                                <h4 style={{ margin: 0, fontSize: '14px', fontWeight: '900', letterSpacing: '1px', color: 'var(--primary)' }}>SESSIONS_SECURITY_PROTOCOL</h4>
                                <p style={{ margin: '4px 0 0 0', fontSize: '12px', opacity: 0.7, maxWidth: '500px', lineHeight: '1.4' }}>
                                    SpectraLabs utilizes secure, cross-site authentication tokens (Cookies) to maintain your administrative uplink and participant mission state.
                                </p>
                            </div>
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                            ...
                            >
                                AUTHORIZE_UPLINK <ArrowRight size={16} />
                            </button>
                        </div>
                    </div>
                </motion.div>
